...
const orderLineService = require('../dealuxeKart-server/backend/services/orderline_service')

//--- TEST FOR POST PRODUCTS SERVICE 

test("objectWithoutInfo", ()=>{ 
  
orderLineService.post(1,"mie","admi123" ,"heyho",123455,"mie@email.com","queens","phil","2019-01-01", "2019-01-01","{test}").then(data => {
...
test("objectWithoutInfo", ()=>{
orderLineService.get(1,"mie","admi123" ,"heyho",123455,"mie@email.com","queens","phil","2019-01-01", "2019-01-01","{test}" ).then(data => {
        expect(data).toBe(undefined)    
    })
})
...
test("objectWithoutInfo", ()=>{
    orderLineService.put(1,"mie","admi123" ,"heyho",123455,"mie@email.com","queens","phil","2019-01-01", "2019-01-01","{test}" ).then(data => {
            expect(data).toBe(undefined)
        })
    })
...
test("objectWithoutInfo", ()=>{
    orderLineService.delete(1,"mie","admi123" ,"heyho",123455,"mie@email.com","queens","phil","2019-01-01", "2019-01-01","{test}" ).then(data => {
            expect(data).toBe(undefined)
        })
    })
test("objectWithInfo", ()=>{
